...
void tutorialShow(int *tuto, int colisionTutorial, int *tutorialActive)
{
    ...
    case 70:
        ...
        break;
    case 72:
        subsCinematicas("CHOCAR CON ELLOS, TE QUITARA VIDAS                                                        ", 40, SCR_HEIGHT - 300, 12, 6, 7);
        subsCinematicas("PUEDES TOMAR UNOS DE LOS CORAZONES QUE CAEN      PARA OBTENER VIDAS ADICIONALES             ", 40, SCR_HEIGHT - 250, 12, 6, 7);
        secondspause(4);
        break;
    case 260:
        if (colisionTutorial)
        ...
        break;
    case 500:
        subsCinematicas(" PRESIONA [ESPACIO] PARA PROTEGERTE DE LOS          METEOROS DISPARANDO TUS MISILES             ", 40, SCR_HEIGHT - 300, 12, 8, 9);
        secondspause(2);
