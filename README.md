...
1. Descarga el archivo instalador [`Cosmic_Chaos_Setup.exe`](https://github.com/FrankSkep/COSMIC_CHAOS-C/releases/tag/v1.0) desde la página de lanzamientos en este repositorio..
