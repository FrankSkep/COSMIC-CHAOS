...
1. Descarga el archivo instalador [`Setup.exe`](https://github.com/FrankSkep/COSMIC_CHAOS-C/releases/tag/1.0.0) desde la página de lanzamientos en este repositorio..
